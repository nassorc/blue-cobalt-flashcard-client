...
export default function LandingPage() {
  return (
    <>
      <div className="relative z-50 text-center space-y-5 flex flex-col justify-start items-center gap-8 py-28 lg:py-60 overlfow-hidden">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button size="icon" className="p-[0.6rem] h-full overflow-hidden">
