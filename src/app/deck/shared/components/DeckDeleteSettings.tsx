...
import { ButtonSm, ButtonSquare } from "../../../../lib/styled/Button.styled";
    ...
    <div>
      ...
      <DialogContainer>
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <p>
            Delete <span>{deck?.deckName}</span>
          </p>
          <ButtonSquare
            onClick={(e) => {
              handleCloseDialog();
...
export default function DeckDeleteSettings({ deck, deckId }) {
  ...
  return (
    <div>
      ...
      <div>
        <ButtonSm onClick={handleDeleteEvent} color="var(--red-color)">
          Delete deck
        </ButtonSm>
      </div>
    </div>
