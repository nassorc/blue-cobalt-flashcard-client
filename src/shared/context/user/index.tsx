import { useState, useEffect, createContext, ReactNode, useContext, Dispatch } from "react";
...
const UserContext = createContext<{ user: UserType, setUser: Dispatch<UserType> }>({
  user: initialData,
  setUser: () => {}
})
