...
export default function SignUpForm() {
  ...
  return (
    <FormShell>
      ...
      {successMessage && <p className='text-green-500'>{successMessage} <Link to="/login" className='text-slate-800 cursor-pointer'>Log in</Link></p>}
      <Form {...form}>
        <form 
          className="space-y-4"
        ...
        >
          ...
          />
          <Button type="submit" className="flex mx-auto py-6 w-full">Create account</Button>
        </form>
        <hr className="mx-3"/>
        <p>Already have an account? <Link to="/login"><span className='inline-block text-website-accent ml-1'>Log in</span></Link></p>
