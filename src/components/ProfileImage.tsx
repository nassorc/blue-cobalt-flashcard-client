...
const ProfileImage = forwardRef(function ProfileImage(
  props: PropType,
  ref: React.ForwardedRef<HTMLDivElement>,
) {
  const { profileImage, size, rounded, className, children, ...divProps } =
    props;
  ...
  return (
    <div {...divProps} className={className}>
      <div
        ref={ref}
        className={cn(
          `bg-[slateblue] aspect-square overflow-hidden`,
